...
BEGIN
  ...
  VALUES 
    (gen_random_uuid(), 'Classic Programming Meme', 'https://images.unsplash.com/photo-1551650975-87deedd944c3?w=600', ARRAY['programming','funny'], u1, 15, 2, 0),
    (gen_random_uuid(), 'Cat Reaction Meme', 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=600', ARRAY['cats','reaction'], u2, 23, 1, 0),
    (gen_random_uuid(), 'Office Life Humor', 'https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?w=600', ARRAY['office','work','relatable'], u1, 8, 0, 0),
    (gen_random_uuid(), 'Weekend Vibes', 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=600', ARRAY['weekend','mood','nature'], u2, 31, 3, 0)
  RETURNING id INTO m1;

  -- Get the first meme ID for comments
  SELECT id INTO m1 FROM public.memes WHERE title = 'Classic Programming Meme' LIMIT 1;
  SELECT id INTO m2 FROM public.memes WHERE title = 'Cat Reaction Meme' LIMIT 1;
